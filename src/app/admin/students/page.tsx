      ...
      <div className="space-y-3">
        {(!students || students.length === 0) ? (
          ...
          students.map(student => (
            <div key={student.user_id} className="bg-white rounded-3xl border border-slate-100 p-4 flex items-center gap-4 shadow-sm">
               <div className="h-10 w-10 rounded-2xl bg-indigo-50 text-indigo-700 flex items-center justify-center font-bold text-sm shrink-0">
